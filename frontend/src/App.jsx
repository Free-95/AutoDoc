...
function App() {
  ...
  const handleLogin = async (e) => {
    e.preventDefault()
    try {
      const res = await axios.post("https://bookish-broccoli-g4xpj9pqp5vq29vg5-8001.app.github.dev/login", {
  ...
  const addStock = async () => {
    ...
    try {
      const res = await axios.post("https://bookish-broccoli-g4xpj9pqp5vq29vg5-8001.app.github.dev/dealer/add-stock", {
  ...
  const assignCar = async (vin) => {
    try {
      const res = await axios.post("https://bookish-broccoli-g4xpj9pqp5vq29vg5-8001.app.github.dev/dealer/assign", {
  ...
  const toggleAttack = async () => {
    ...
    setAttackMode(next)
    await axios.post(`https://bookish-broccoli-g4xpj9pqp5vq29vg5-8001.app.github.dev/toggle-attack/${next}`)
  }
  ...
  const bookService = async () => {
    ...
    try {
      const res = await axios.post("https://bookish-broccoli-g4xpj9pqp5vq29vg5-8001.app.github.dev/book-service", {
  ...
  useEffect(() => {
    ...
    const ws = new WebSocket(`wss://bookish-broccoli-g4xpj9pqp5vq29vg5-8001.app.github.dev/ws/1?vehicle_id=${selectedCar.id}&role=user`)
  ...
  useEffect(() => {
    const fetchSecurity = async () => {
      ...
      try {
        const res = await axios.get("https://bookish-broccoli-g4xpj9pqp5vq29vg5-8001.app.github.dev/security/logs")
