...
export default function ChatbotWidget({ vehicleId, styles }) {
  ...
  const fetchAlerts = async () => {
    try {
      const res = await axios.get("https://bookish-broccoli-g4xpj9pqp5vq29vg5-8001.app.github.dev/alerts/active")
  ...
  const ask = async (overrideQuestion) => {
    ...
    setLoading(true)
    try {
      const res = await axios.post("https://bookish-broccoli-g4xpj9pqp5vq29vg5-8001.app.github.dev/chatbot/query", {
